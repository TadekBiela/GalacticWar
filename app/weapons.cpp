...
weapon const defaultWeapon = { weapon_type::defWeapon, 1, &defaultFireFunc, 20 };

weapon const redWeapons[def::maxWeaponLevel] = {
...
weapon const yellowWeapons[def::maxWeaponLevel] = {
...
weapon const blueWeapons[def::maxWeaponLevel] = {
